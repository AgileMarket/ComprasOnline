...
export default class Menuinterfazcliente extends Component {
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                ...
                                {/*Etiqueta a se reemplaza por link, y los href se reemplaza por to*/}
                                <Link className="nav-link active" aria-current="page" to="/listaproductoscliente">Lista productos</Link>
                            </li>
